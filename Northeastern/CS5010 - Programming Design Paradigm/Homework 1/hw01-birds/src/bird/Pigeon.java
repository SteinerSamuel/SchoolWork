...
/**
 * A class which represents the pigeon classificaiton.
 */
public class Pigeon extends BirdAbstract {
  private final ArrayList<String> baseCharacteristics = new ArrayList<>(
          Arrays.asList("Feeds young 'bird milk'"));

  /**
   * The default constructor for the pigeon class.
   *
   ...
   */
  public Pigeon(String name, boolean extinct, int wings, ArrayList<Food> diet) {
    this.name = name;
  ...
  /**
   * A constructor used if a pigeon has characteristics which are outside the base List.
   *
   * @param name                  The name of the bird.
   * @param extinct               Is the bird extinct.
   * @param wings                 the number of wings the bird has.
