...
Description: A multi-threaded server which feeds files to a client based on the uri. This program uses port 8080
...
def main():
    ...
    while True:
        ...
        try:
            ...
            _thread.start_new(make_connection, (connection_socket, ))
        except IOError:
